...
export function useWebSocket(sessionId: string, token: string | null) {
  ...
  const handleMessage = useCallback((raw: string) => {
    ...
    setDocument, setRevision, setParticipants,
    applyRemoteEdit, updateCursor, addParticipant,
    removeParticipant, appendToken, finishStreaming,
  ])
